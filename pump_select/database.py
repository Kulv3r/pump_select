...
class Model(CRUDMixin, db.Model):
    ...
    def __repr__(self):
        return '<{classname} #{self_id}>'.format(
...
class CreatedAtTimestamp(object):
    created_at = Column(db.DateTime, default=db.func.now())


class UpdatedAtTimestamp(object):
    updated_at = Column(db.DateTime, default=db.func.now(), onupdate=db.func.now())


class DeletedAtTimestamp(object):
    deleted_at = Column(db.DateTime)


class Timestamps(CreatedAtTimestamp, UpdatedAtTimestamp, DeletedAtTimestamp):
    """
